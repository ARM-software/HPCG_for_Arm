...
HPCG_DEPS = src/CG.o src/CG_ref.o src/TestCG.o src/ComputeResidual.o \
	 ...
	 src/SetupHalo.o src/SetupHalo_ref.o src/TestSymmetry.o src/TestNorms.o src/WriteProblem.o \
         ...
         src/ComputeMG_ref.o src/ComputeMG.o src/ComputeProlongation.o src/ComputeProlongation_ref.o \
         src/ComputeRestriction.o src/ComputeRestriction_ref.o src/GenerateCoarseProblem.o \
